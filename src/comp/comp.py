...
c = [human for human in humans if human.name[0] > 'C' and human.name[0] < 'H']
print(c)
...
f = [(f"{human.name}", human.age) for human in humans if human.age in range(27, 32+1)]
print(f)
...
import math
h = [(human.name, math.sqrt(human.age)) for human in humans]
print(h)
